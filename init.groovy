...
// Allow all JobDSL groovy files to execute by turning off script security for them
// This is necessary for automation, otherwise every script needs to be manually
// approved in the UI
